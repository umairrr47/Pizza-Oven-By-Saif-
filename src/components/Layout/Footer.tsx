  ...
  return (
    <footer className="relative bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col items-start gap-3">
                ...
                <div className="text-[15px] leading-7 text-white font-semibold">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li>
                <Link to="/who-we-are" className="hover:text-white transition-colors duration-300">
                  Who We Are
                </Link>
              </li>
              <li>
          ...
          {/* Our Treatments */}
          <div className="md:col-span-2">
            <h4 className="text-base font-semibold mb-4 text-white">Our Treatments</h4>
            <ul className="space-y-3 text-sm text-gray-300">
              <li>
                <Link to="/products/commercial-oven" className="hover:text-white transition-colors duration-300">
                  Commercial Oven
                </Link>
              </li>
              <li>
                <Link to="/products/portable-oven" className="hover:text-white transition-colors duration-300">
                  Portable Oven
                </Link>
              </li>
              <li>
                <Link to="/products/residential-oven" className="hover:text-white transition-colors duration-300">
                  Residential Oven
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-4 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@thepizzaovens.com" className="hover:text-white transition-colors duration-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919899593526" className="hover:text-white transition-colors duration-300">
                  +91 989 959 35 26
                </a>
              </div>
            </div>
        ...
        {/* Divider + Bottom bar */}
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between text-xs sm:text-sm text-gray-400">
