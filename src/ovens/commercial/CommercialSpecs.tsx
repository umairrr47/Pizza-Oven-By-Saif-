...
export default function CommercialSpecs(): JSX.Element {
                ...
                <div className="mx-auto w-full max-w-[1175px] bg-white rounded-[20px] shadow-sm">
                    ...
                    <div className="p-6 md:p-10 lg:p-12">
                        <div className="section-heading reveal">
                            ...
                            >
                                Know More About The Pizza <br /> Oven By Saif Commercial Pizza Oven
                            </h2>

                            <p className="text-[16px] md:text-[18px] text-[#575757] leading-[1.7] tracking-[0.02em] mb-6">
                                Explore the full specs and guarantees of our premium ovens
                            </p>
                            ...
                            <ul className="flex flex-col sm:flex-row gap-3 mt-4">
                                ...
                                <li className="w-full sm:w-auto">
                                    <button
                                        ...
                                        className={`w-full sm:w-auto block text-center px-5 py-2 rounded-xl text-[16px] md:text-[18px] transition ${activeTab === "tab2" ? "bg-[#e30715] text-white" : "bg-white border border-gray-300 text-gray-800 hover:bg-gray-100"
                                            }`}
                                    >
                                        Steel Ovens
                                    </button>
                    ...
                    <div className="px-6 md:px-10 lg:px-12 pb-10 md:pb-12 tab-content-wrapper reveal">
                                            ...
                                            <table className="w-full text-base text-gray-800 border-collapse">
                                                <tbody>
                                                    <tr className="border-t border-gray-200">
                                                        ...
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Extra large brick oven</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Large brick oven</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Standard brick oven</td>
                                                    </tr>
                                                    ...
                                                    <tr className="border-t border-gray-200">
                                                        ...
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">7-8 pizza at a time 120 pizza par hours</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">5-6 pizza at a time 90 pizza par hours</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">3-4 pizza at a time 60 pizza par hours</td>
                                                    </tr>

                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">Materials</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Thick fire bricks dome thick fire bricks cooking base</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Thick fire bricks dome thick fire bricks cooking base</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Thick fire bricks dome thick fire bricks cooking base</td>
                                                    </tr>
                                            ...
                                            <table className="w-full text-base text-gray-800 border-collapse">
                                                <tbody>
                                                    ...
                                                    <tr className="border-t border-gray-200">
                                                        ...
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">140 x 140 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">120 x 120 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">100 x 100 cm</td>
                                                    </tr>

                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">External</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">190 x 190 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">170 x 170 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">150 x 150 cm</td>
                                                    </tr>

                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">Mouth width</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">52.5 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">52.5 cm</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">52.5 cm</td>
                                                    </tr>
                                                    ...
                                                    <tr className="border-t border-gray-200">
                                                        ...
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Semi portable 1500 kg fixed 2200 kg</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Semi portable 1200 kg fixed 1800 kg</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Semi portable 1000 kg fixed 1500 kg</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                        ...
                        {/* ---------- TAB 2 - STEEL (same framed style & responsiveness) ---------- */}
                        <div style={{ display: activeTab === "tab2" ? "block" : "none" }}>
                            <div className="tab-content-inner mt-3">
                                <h4 className="text-[clamp(20px,2vw,28px)] font-normal text-gray-950 tracking-[0.015em] mb-4">Specification:</h4>
                                        ...
                                        <div className="min-w-[640px]">
                                            <table className="w-full text-base text-gray-800 border-collapse">
                                                <tbody>
                                                    ...
                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">Shape</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Barrel</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Dome</td>
                                                    </tr>

                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">Capacity</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">4 pizza at a time 48 pizza par hours</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">3 pizza at a time 36 pizza par hours</td>
                                                    </tr>

                                                    <tr className="border-t border-gray-200">
                                                        <td className="py-3 px-4 font-semibold text-gray-700">Materials</td>
                                                        <td className="py-3 px-4 text-[16px] text-[#575757]">Stainless steel dome Fire bricks cooking base</td>
                            ...
                            {/* Dimension & Weight framed */}
                            <div className="tab-content-inner mt-6">
                                <h4 className="text-[clamp(20px,2vw,28px)] font-normal text-gray-950 mb-4">Dimension &amp; Weight:</h4>
                            ...
                            {/* Warranty framed */}
                            <div className="tab-content-inner mt-6">
                                <h4 className="text-[clamp(20px,2vw,28px)] font-normal text-gray-950 mb-4">Warranty:</h4>
                                <div className={`${INNER_FRAME} p-6 md:p-10`}>
                                    <p className="text-[16px] md:text-[17px] text-[#575757] leading-[1.6]">
                                        All Saif Oven has 1-year on-site warranty and a lifetime guarantee against manufacturing defects.
                                    </p>
