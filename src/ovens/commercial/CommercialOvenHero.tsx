...
const CommercialOvenHero: React.FC<{
  slides?: Slide[];
  autoplay?: boolean;
  interval?: number;
      ...
      <section className="pt-20 md:pt-24 pb-16 md:pb-20 px-4 sm:px-6 md:px-10 lg:px-12 bg-gradient-to-b from-white via-gray-50 to-gray-100 text-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={headingRef} className="text-center max-w-4xl mx-auto mb-10 md:mb-12">
            ...
            >
              Pizza Oven By Saif brings you the authentic charm of Italy with every commercial pizza oven —
              designed to elevate your kitchen’s aesthetic and deliver reliable, high-performance cooking for
              restaurants, hotels, and culinary professionals across India.
            </motion.p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 py-12 md:py-20 pb-12 md:pb-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div ref={contentRef} className="lg:col-span-8">
                <h2 data-scroll className="text-[clamp(40px,4.2vw,64px)] leading-tight font-light mb-6 font-poppin">
                  About Commercial Pizza Oven
                </h2>

                <p data-scroll className="text-[16px] md:text-[18px] text-gray-300 leading-[1.8] tracking-[0.02em] mb-6 font-inter">
                  The Pizza Oven BY Saif the commercial pizza ovens are the modern evolution of traditional Italian ovens,
                  designed for professional kitchens: restaurant, pizzeria and catering. those oven bring together centuries
                  of Italian craftsmanship with cutting edge materials and engineering practices. marco's oven delivers
                ...
                <p data-scroll className="text-[16px] md:text-[18px] text-gray-300 leading-[1.8] tracking-[0.02em] mb-6 font-inter">
                  At The Pizza Oven By Saif, choose from high-output brick ovens or efficient portable ovens—each designed
                  for demanding, high-volume use. Every commercial pizza oven offers unmatched performance, durability,
                  and energy efficiency, tailored for restaurants, pizzerias, food trucks, and catering kitchens.
                </p>
                ...
                <div data-scroll className="mb-6">
                  ...
                  <p className="text-[16px] md:text-[18px] text-gray-300 leading-[1.8] tracking-[0.02em] mb-6 font-inter">
                    Brick ovens offer the highest output and heat retention, with minimal maintenance—perfect for
                    pizzerias, restaurants, and breweries where long-term performance and productivity are essential.
                  </p>
                </div>
...
export default CommercialOvenHero;
