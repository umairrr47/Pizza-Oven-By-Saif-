...
const PortableOvenHero: React.FC<{
  slides?: Slide[];
  autoplay?: boolean;
  interval?: number;
      ...
      <section className="pt-20 md:pt-24 pb-16 md:pb-20 px-4 sm:px-6 md:px-10 lg:px-12 bg-gradient-to-b from-white via-gray-50 to-gray-100 text-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={headingRef} className="text-center max-w-4xl mx-auto mb-10 md:mb-12">
            ...
            >
              Saif’s portable ovens deliver the best cooking results and are designed for easy transportation, making them perfect for events, food trucks, and anyone who needs to relocate their oven.
            </motion.p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div ref={contentRef} className="lg:col-span-8">
                <h2 data-scroll className="text-[clamp(28px,3.2vw,54px)] font-light leading-tight text-gray-100 font-neuehaas">
                  About Portable Pizza Oven
                </h2>

                <p data-scroll className="mt-5 text-[clamp(14px,1.6vw,18px)] text-[#BCBCBC] leading-relaxed font-helvetica tracking-wide">
                  At Saif Ovens, our portable pizza ovens represent the next generation of professional wood-fired innovation - crafted for caterers, food trucks, and modular kitchens.
                  Designed in India with precision and passion, each oven blends traditional techniques with advanced materials to ensure exceptional heat retention, fuel efficiency, and consistent results.
                  Enjoy authentic wood-fired performance wherever your kitchen takes you - compact, reliable, and built to last.
                </p>
                ...
                <p data-scroll className="mt-5 text-[clamp(14px,1.6vw,18px)] text-[#BCBCBC] leading-relaxed font-helvetica tracking-wide">
                  At Saif Ovens, choose from our compact portable oven made for food trucks and catering setups, along with our small, medium, and large steel wood-fired ovens. Every model is fully portable and built to suit a wide range of environments - from professional mobile kitchens to residential spaces.
                </p>
                ...
                <div data-scroll className="mb-6">
                  ...
                  <p className="mt-5 text-[clamp(14px,1.6vw,18px)] text-[#BCBCBC] leading-relaxed font-helvetica tracking-wide">
                   Designed for mobility-focused professionals, our portable ovens offer strong heat output, reliable temperature stability, and effortless portability - perfect for chefs who need authentic wood-fired performance on the move.
                  </p>
                </div>
                ...
                <div data-scroll>
                  ...
                  <p className="text-[16px] md:text-[18px] text-gray-300 leading-[1.8] tracking-[0.02em] mb-6 font-inter">
                   Available in large, medium, and small sizes, Saif’s steel ovens are versatile units ideal for homes and small businesses. They combine durability, flexibility, and powerful heat performance to deliver an exceptional wood-fired experience wherever you choose to cook.
                  </p>
                </div>
              </div>
...
export default PortableOvenHero;
