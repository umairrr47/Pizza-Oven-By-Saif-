...
const ITEMS: OvenItem[] = [
  {
    ...
    blurb:
      "The medium steel oven offers a good output and heat retention. It’s an indoor & outdoor oven with the flexibility to run with wood, gas or hybrid, this oven feature a thick stainless steel dome and brick base and it produces high-quality pizza at home. the oven is compact and cost effective and can be Easily moved.",
  },
  {
    id: "/02",
    title: "Small Steel Oven",
    blurb:
      "The small steel oven offers a decent output and good heat retention. It’s an outdoor oven but can run indoor with ventilation. This oven feature a thick stainless steel dome and brick base and it produces high-quality pizza at home. It’s a gas oven but can run hybrid too with small quantities of wood, the oven is very compact and very cost effective and can be Easily moved.",
  },
  
];

const ResidentialOvenDetails: React.FC = () => {
      ...
      >
        ...
        >
          ...
          <div className="mb-8 md:mb-12">
            ...
            >
              All About Residential Wood Fired Pizza <br /> Oven – By Saif Ameer
            </h2>

            <p className="subtext text-[15px] sm:text-[16px] md:text-[18px] text-[#bcbcbc] leading-[1.6] md:leading-[1.7] tracking-[0.02em] mb-6">
              Experience high-precision Indian craftsmanship with Saif’s Residential wood-fired pizza <br /> ovens - thoughtfully engineered for powerful performance, long-lasting durability,<br /> and deep, authentic flavor. Perfect for caterers, food trucks, and chefs who <br /> need mobility with professional quality, each oven blends traditional techniques <br /> with modern technology to deliver consistently exceptional results.
            </p>
          </div>
...
export default ResidentialOvenDetails;
