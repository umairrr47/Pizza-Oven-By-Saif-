...
// export default function CommercialAbout({ className = "" }: Props) {
...
//           <div className="flex flex-wrap lg:flex-nowrap justify-between relative text-white py-12">
//             {/* LEFT: approx 65% / full-width on small screens */}
//             <div ref={leftRef} className="w-full lg:w-[65%] pr-0 lg:pr-8">
...
//                     Prices vary based on size and custom features, but the long-term benefits are well worth it. Get started by filling out our enquiry form for a comprehensive catalogue with pricing details.
//                   </p>
//                 </article>
...
//                     style={{ fontFamily: '"NeueHaasGroteskDisp Pro", sans-serif' }}
//                   >
//                     Cost Of A Portable Or A Large Steel Oven
//                   </h4>
//                   <p className="text-[16px] md:text-[17px] text-gray-300 leading-[1.6] tracking-[0.02em]">
//                     Those oven are cost effective! Prices depends on the size and customization. Get started by filling out our enquiry form for a comprehensive catalogue with pricing details.
//                   </p>
//                 </article>
//               </div>
//             </div>
...
//                   <div className="bg-[#292929] border border-gray-800 rounded-xl p-6 shadow-lg">
//                     <h5 className="text-[clamp(20px,2vw,28px)] font-normal text-gray-100 tracking-[0.025em] mb-4">We’re Here to Help</h5>
