...
export default function AboutFounderClone({ imageSrc }: Props) {
  // fallback to imported Saif image when imageSrc is missing/invalid
  const mobileSrc = imageSrc || Saif;
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute left-0 top-4 md:top-8 w-[200%] transform-gpu animate-marquee z-0">
          <h2
            ...
            style={{
              fontFamily:
                '"NeueHaasGroteskDisp Pro", system-ui, -apple-system, "Segoe UI", Roboto',
            }}
          >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-12 lg:py-10 flex flex-col lg:flex-row items-center justify-center relative z-10">
        ...
        <div className="w-full lg:w-1/2 lg:pr-16 flex flex-col items-center lg:items-start text-center lg:text-left">
          <div className="pt-16 md:pt-0">
            {/* Heading */}
            <h1
              className="text-[clamp(30px,3.2vw,56px)] leading-[1.1] font-light tracking-[0.03em] text-gray-100 lg:mt-20 py-2"
              style={{ fontFamily: '"NeueHaasGroteskDisp Pro", sans-serif' }}
            >
              The Founder of The
              <br />
              Pizza Ovens <br /> By Saif
            </h1>

            {/* Paragraph */}
            <p className="text-[16px] md:text-[18px] text-[#BCBCBC] leading-[1.7] tracking-[0.02em] mb-6 py-6 lg:py-8">
              Saif is more than an oven maker-he's a designer, craftsman, and food
              enthusiast who understands the soul of wood-fired cooking. Born and
              raised in India, he blends traditional techniques with modern
              engineering to create ovens that chefs trust and professionals rely
              on. Over the years, he has built a brand respected by restaurants,
              admired by chefs, and recognized for performance.
            </p>

            {/* Mobile Image - Show after paragraph on mobile */}
            <div className="lg:hidden w-full my-8">
              <div className="w-full h-100 rounded-xl overflow-hidden bg-[#0e0e0e] flex items-center justify-center">
                {/* Use mobileSrc (fallback) */}
                <img
                  src={mobileSrc}
                  alt="Saif Ameer"
                  className="max-h-full max-w-full object-contain object-center"
                  onError={(e) => {
                    // In the rare case even imported image fails, hide broken icon and fallback to Saif
                    const target = e.currentTarget as HTMLImageElement;
                    if (target.src !== Saif) target.src = Saif;
                  }}
                />
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-start my-4">
              <img src={Qoute} alt="Quote decoration" className="h-6 w-auto opacity-60" />
            </div>

            {/* Quote section */}
            <blockquote className="mt-6 mb-6">
              <p
                className="text-[clamp(20px,1.5vw,28px)] font-normal text-gray-100"
                style={{ fontFamily: '"NeueHaasGroteskDisp Pro", sans-serif' }}
              >
                "An oven isn't just equipment - it's where <br />
                fire, craft, and flavour come alive."
              </p>
              <footer
                className="mt-6 text-xl font-semibold text-[#BCBCBC]"
                style={{
                  fontFamily:
                    '"NeueHaasGroteskDisp Pro", system-ui, -apple-system, "Segoe UI", Roboto',
                }}
              >
                — Saif Ameer
                <br />
                <span className="pl-6 text-[13px] text-[#BCBCBC]">Saif Ameer Founder &amp; CEO</span>
              </footer>
            </blockquote>
            ...
            <div className="mt-8 lg:mt-12 flex justify-center lg:justify-start">
              <a
                href={`https://wa.me/919899593526?text=Hi%20Saif%2C%20I%20would%20like%20to%20chat%20about%20pizza%20ovens`}
                target="_blank"
