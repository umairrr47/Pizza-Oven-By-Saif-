...
export const products: Product[] = [
  {
    ...
    description:
      "Traditional Italian dome with refractory core for Neapolitan char and leopard spotting.",
    specifications: {
  ...
  },
  {
    ...
    description:
      "Commercial-grade burner array with PID control—repeatable bakes during rush hours.",
    specifications: {
  ...
  },
  {
    ...
    description:
      "Dual-fuel flagship—wood flavour on demand, gas convenience on schedule.",
    specifications: {
    ...
    features: [
      "Dual fuel switch-over",
      "Pressure fail-safe",
      "Chef-calibrated deck",
      "Service network ready",
    ],
    rating: 4.9,
    reviewsCount: 41,
  ...
  },
  {
    ...
    specifications: {
      dimensions: "110 × 98 × 62 cm",
      weight: "68 kg",
      capacity: '1 × 16" pizza',
      temperature: "510°C peak",
      material: "SS 304, cordierite stone",
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      weight: "120 kg",
      capacity: '2 × 14" pizzas',
      temperature: "0–420°C",
      material: "SS, mineral wool",
    },
